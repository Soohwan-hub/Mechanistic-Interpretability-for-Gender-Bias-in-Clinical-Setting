...
\workshoptitle{Interpretability for Discovery (Interp4Discovery)}
% \nolinenumbers
\usepackage{latexsym}
\usepackage{graphicx}
\usepackage{booktabs}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.75\linewidth]{fig2_token_association_table.png}
...
% \begin{figure}[htb]
%     \centering
%     \includegraphics[width=1\linewidth]{qwen_cot20_mlp_rewrite_l18_first_cond_heatmap.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{simple_vs_cot_l18_comparison.png}
